<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="ServiceSetting.aspx.cs" Inherits="Varanegar.Admin.ServiceSetting" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:MultiView ID="mvSetting" runat="server" ActiveViewIndex="0">
        <asp:View ID="vwList" runat="server">
            ...
            <a href="/Admin/ServiceSetting.aspx?type=Recycle" class="btn btn-default">مشاهده گروه های خدمات حذف شده</a>
            <br />
            <br />
            ...
            <asp:GridView ID="grdTable" runat="server" AutoGenerateColumns="False" OnDataBound="grdTable_OnDataBound" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowCommand="grdProductGroup_RowCommand">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="تنظیمات">
                        <ItemTemplate>
                            <asp:HiddenField ID="hfValue" Value='<%# Eval("ServiceID") %>' runat="server" />
                            ...
                            <br />
                            <asp:LinkButton ID="lbDelete" runat="server" CommandArgument='<%# Eval("ServiceID") %>' CommandName="DoDelete" CssClass="lb"><i class="fa fa-remove"></i>حذف</asp:LinkButton>
                            <br />
                             <br />
                               <asp:LinkButton ID="lbRecycle" runat="server" CommandArgument='<%# Eval("ServiceID") %>' CommandName="recycle" CssClass="lb">
       ...
       <div class="alert alert-danger">
            ...
            هستید؟
                 <br />
            با حذف این گروه، خدمات زیر مجموعه آن نیز حذف می شوند.
                <br />
                <br />
