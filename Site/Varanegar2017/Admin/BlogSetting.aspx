<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="BlogSetting.aspx.cs"  Inherits="Varanegar.Admin.BlogSetting" %>
        ...
        <asp:View ID="vwList" runat="server">
         <asp:Button ID="btnAdd" runat="server" Text="افزودن" OnClick="btnAdd_Click" CssClass="btn btn-success" />
            <asp:Button ID="btnReturn" runat="server" Text="بازگشت" OnClick="btnReturn_Click" CssClass="btn btn-warning" CausesValidation="false" />
                        <a href="/Admin/BlogSetting.aspx?type=Recycle" class="btn btn-default">مشاهده اخبار حذف شده</a>
           ...
           <asp:GridView ID="grdTable" runat="server" OnDataBound="grdTable_OnDataBound" AutoGenerateColumns="False" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowCommand="grdProductGroup_RowCommand">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="تنظیمات">
                        <ItemTemplate>
                      <asp:HiddenField ID="hfValue" Value='<%# Eval("BlogID") %>' runat="server" />
                            <i class="fa fa-edit"></i>
                            <asp:LinkButton ID="lbEdit" runat="server" CausesValidation="False" CommandArgument='<%# Eval("BlogID") %>' CommandName="DoEdit" CssClass="lb">ویرایش</asp:LinkButton>
                              <br /> 
                            <asp:LinkButton ID="lbDelete" runat="server" CausesValidation="False" CommandArgument='<%# Eval("BlogID") %>' CommandName="DoDelete" CssClass="lb"><i class="fa fa-times"></i>حذف</asp:LinkButton>
                           <%-- <br />
                               <i class="fa fa-sitemap"></i>
                            <a href='<%# Eval("BlogID","commentSetting.aspx?ID={0}") %>'>مشاهده نظرات</a>--%>
                            <br />
                              <asp:LinkButton ID="lbRecycle" runat="server" CommandArgument='<%# Eval("BlogID") %>' CommandName="recycle" CssClass="lb">
...
<%--                               <asp:RegularExpressionValidator Display = "Dynamic" ControlToValidate = "txtSummery" ID="RegularExpressionValidator2" ValidationExpression = "^[\s\S]{0,130}$" runat="server" ErrorMessage="جهت نمایش بهتر مطالب، طول متن کوتاه نباید بیشتر از 130 کاراکتر باشد" ForeColor="Red">*</asp:RegularExpressionValidator>--%>
                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          <%--  <telerik:RadEditor runat="server" ID="reDesc"
                                ImageManager-EnableImageEditor="true"
                                ImageManager-UploadPaths="~/Uploads/Service/Editor/"
                                ImageManager-ViewPaths="~/Uploads/Service/Editor/"
                                ></telerik:RadEditor>--%>
                        </td>
                    </tr>
                     <tr>
                        ...
                        <td>
                          ...
                          <%--  <telerik:RadEditor runat="server"    ImageManager-EnableImageEditor="true"
                                ImageManager-UploadPaths="~/Uploads/Service/Editor/"
                                ImageManager-ViewPaths="~/Uploads/Service/Editor/"   ID="reEN_Desc"></telerik:RadEditor>--%>
                        </td>
                    </tr>
             <tr>
                        <td>تاریخ ثبت</td>
