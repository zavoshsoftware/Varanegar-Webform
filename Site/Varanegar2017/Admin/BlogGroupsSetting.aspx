<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="BlogGroupsSetting.aspx.cs" Inherits="Varanegar.Admin.BlogGroupsSetting" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:MultiView ID="mvSetting" runat="server" ActiveViewIndex="0">
        <asp:View ID="vwList" runat="server">
            ...
            <a href="/Admin/BlogGroupsSetting.aspx?type=Recycle" class="btn btn-default">مشاهده گروه های اخبار حذف شده</a>
            <br />
            <br />
            ...
            <asp:GridView ID="grdTable" runat="server" OnDataBound="grdTable_OnDataBound" AutoGenerateColumns="False" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowCommand="grdProductGroup_RowCommand">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="BlogGroupTitle" HeaderText="عنوان" />
                    ...
                    <asp:TemplateField HeaderText="تنظیمات">
                        <ItemTemplate>
                              <asp:HiddenField ID="hfValue" Value='<%# Eval("BlogGroupID") %>' runat="server" />
                            ...
                            <br />
                            <asp:LinkButton ID="lbDelete" runat="server" CommandArgument='<%# Eval("BlogGroupID") %>' CommandName="DoDelete" CssClass="lb"> <i class="fa fa-times"></i>حذف</asp:LinkButton>
                            <br />
                                <asp:LinkButton ID="lbRecycle" runat="server" CommandArgument='<%# Eval("BlogGroupID") %>' CommandName="recycle" CssClass="lb">
        ...
        <asp:View ID="vwDelete" runat="server">
           <div class="alert alert-danger">
            ...
            هستید؟
                 <br />
            با حذف این گروه، اخبار زیر مجموعه آن نیز حذف می شوند.
                <br />
                <br />
