<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="GalleryImageSetting.aspx.cs" Inherits="Varanegar.Admin.GalleryImageSetting" ValidateRequest="false"%>
         ...
         <asp:Button ID="btnAdd" runat="server" Text="افزودن" OnClick="btnAdd_Click" CssClass="btn btn-success" />
           ...
           <asp:GridView ID="grdTable" runat="server" AutoGenerateColumns="False" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowCommand="grdProductGroup_RowCommand">
                ...
                <Columns>
                 ...
                 <%--   <asp:BoundField DataField="GalleryGroupTitle" HeaderText="عنوان گروه" />--%>
                    <%-- <asp:TemplateField HeaderText="نصویر">
                        <ItemTemplate>
                            <img src=""
                              </ItemTemplate>
                    </asp:TemplateField>--%>
                ...
                <table>
                  ...
                  <tr>
                     ...
                     <tr>
                      ...
                      <tr>
                        <td>آدرس لینک ویدئو</td>
                        <td>
                            <asp:TextBox ID="txtVideoLink" runat="server" CssClass="form-control" Width="300px"></asp:TextBox>
