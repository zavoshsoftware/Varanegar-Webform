<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SuperAdmin/MainMaster.Master" AutoEventWireup="true" CodeBehind="ProductGroupSetting.aspx.cs" Inherits="MashadCarpet.Admin.SuperAdmin.mainProductGroupSetting" %>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="تنظیمات">
                        <ItemTemplate>
                            ...
                            <a href='<%# Eval("ProductGroupID","productsetting.aspx?ID={0}") %>'>مدیریت محصولات</a>
