<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SuperAdmin/MainMaster.Master" AutoEventWireup="true" CodeBehind="CustomerGroupSetting.aspx.cs" Inherits="Varanegar.Admin.SuperAdmin.CustomerGroupSetting" %>
                    ...
                    <asp:TemplateField HeaderText="تنظیمات">
                        <ItemTemplate>
                         ...
                         <%--    <i class="fa fa-edit"></i>
                            ...
                            <asp:LinkButton ID="lbDelete" runat="server" CommandArgument='<%# Eval("CustomerGroupID") %>' CommandName="DoDelete" CssClass="lb">حذف</asp:LinkButton>
                            <br />
                               <i class="fa fa-sitemap"></i>
                            <a href='<%# Eval("CustomerGroupID","customersetting.aspx?ID={0}") %>'>مدیریت مشتریان</a>
