<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="ProductSetting.aspx.cs" Inherits="MashadCarpet.Admin.ProductSetting" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:MultiView ID="mvSetting" runat="server">
      ...
      <a href="/Admin/ProductSetting.aspx?type=Recycle"  class="btn btn-default">مشاهده محصولات حذف شده</a>
            ...
            <asp:GridView ID="grdTable" runat="server" OnDataBound="grdTable_OnDataBound" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowCommand="grdTable_RowCommand" Width="100%" AllowPaging="True" PageSize="15" OnPageIndexChanging="grdTable_PageIndexChanging">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="توضیحات">
                        <ItemTemplate>
                            <asp:HiddenField ID="hfValue" Value='<%# Eval("ProductID") %>' runat="server" />
                            ...
                            <asp:LinkButton ID="lbDelete" runat="server" CommandArgument='<%# Eval("ProductID") %>' CommandName="DoDelete" CssClass="lb"> <i class="fa fa-remove"></i>حذف</asp:LinkButton>
                           <br />
                            <asp:LinkButton ID="lbRecycle" runat="server" CommandArgument='<%# Eval("ProductID") %>' CommandName="recycle" CssClass="lb">
