<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="ServiceStepsSetting.aspx.cs" Inherits="Varanegar.Admin.serviceitemssetting" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:MultiView ID="mvSetting" runat="server">
        <asp:View ID="vwList" runat="server">
            ...
            <a href="/Admin/ServiceStepsSetting.aspx?type=Recycle" class="btn btn-default">مشاهده خدمات حذف شده</a>
            <br />
            <br />
            ...
            <asp:GridView ID="grdTable" runat="server" OnDataBound="grdTable_OnDataBound" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowCommand="grdTable_RowCommand" Width="100%" AllowPaging="True" PageSize="5" OnPageIndexChanging="grdTable_PageIndexChanging">
                ...
                <Columns>
                  <asp:BoundField DataField="Priority" HeaderText="ردیف" />  
                    ...
                    <asp:TemplateField HeaderText="توضیحات">
                        <ItemTemplate>
                            <asp:HiddenField ID="hfValue" Value='<%# Eval("ServiceStepID") %>' runat="server" />
                            ...
                            <asp:LinkButton ID="lbDelete" runat="server" CommandArgument='<%# Eval("ServiceStepID") %>' CommandName="DoDelete" CssClass="lb"> <i class="fa fa-times"></i>حذف</asp:LinkButton>
                              <asp:LinkButton ID="lbRecycle" runat="server" CommandArgument='<%# Eval("ServiceStepID") %>' CommandName="recycle" CssClass="lb">
