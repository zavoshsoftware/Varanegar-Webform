...
namespace OrganizationalMaturityAssessment.Admin
{
    public partial class MainMaster : System.Web.UI.MasterPage
    {
        ...
        {
            string textId =WebConfigurationManager.AppSettings["brandTextId"];
            hlSecondBrand.NavigateUrl = "textsetting.aspx?id=" + textId;
        }
        public void FindActiveMenu()
        {
            ...
            else if (strPage == "~/Admin/contactForms.aspx" || strPage == "~/Admin/CareerListSetting.aspx" || strPage == "~/Admin/DemoListSetting.aspx")
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "PageScript",
